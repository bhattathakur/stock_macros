...
snp_df=pd.read_csv("/home/thakur/stock_information/nasdaq100.csv",keep_default_na=False)['Ticker'].tolist() #snp 500 companies
print(f"NASDAQ100: \n{len(snp_df)}")
snp_df=[i.replace(".","-") for i in snp_df]
save_loc="/home/thakur/test/nasdaq100/"
