#!/bin/python3
#to create the nasdaq-100 direcotry 
import os
import pandas as pd
import yfinance as yf

snp_df=pd.read_csv("/home/thakur/stock_information/snp500finalwvol.csv",keep_default_na=False)['SYMBOL'].tolist() #snp 500 companies
print(f"snp500: \n{len(snp_df)}")
snp_df=[i.replace(".","-") for i in snp_df]
save_loc="/home/thakur/test/snp500/"
